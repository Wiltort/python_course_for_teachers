...
class TestTaskSolution(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..","..","app", "tests")))
    ...
    def test_random_10(self):
        ...
        for _ in range(10):
            ...
            result = run_with_timeout(self.run_program_with_input, self.timeout, input_string)
